...
func TestButtonPrimary(t *testing.T) {
	...
	b := &bytes.Buffer{}
	Button().Content(Raw("Hello, world!")).Render(b)
...
func TestButtonSecondary(t *testing.T) {
	...
	b := &bytes.Buffer{}
	Button().Content(Raw("Hello, world!")).Kind("secondary").Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
...
func TestButtonTertiary(t *testing.T) {
	...
	b := &bytes.Buffer{}
	Button().Content(Raw("Hello, world!")).Kind("tertiary").Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
...
func TestButtonGhost(t *testing.T) {
	...
	b := &bytes.Buffer{}
	Button().Content(Raw("Hello, world!")).Kind("ghost").Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
...
func TestButtonDanger(t *testing.T) {
	...
	b := &bytes.Buffer{}
	Button().Content(Raw("Hello, world!")).Kind("danger").Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
...
func TestButtonDangerTertiaryIconOnly(t *testing.T) {
	...
	b := &bytes.Buffer{}
	Button().Kind("danger-tertiary").Icon(Raw(svg)).IconDescription("Delete").Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
...
func TestButtonDisabled(t *testing.T) {
	...
	b := &bytes.Buffer{}
	Button().Content(Raw("Hello, world!")).Disabled(true).Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
...
func TestButtonDangerGhost(t *testing.T) {
	...
	b := &bytes.Buffer{}
	Button().Content(Raw("Hello, world!")).Kind("danger-ghost").Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
...
func TestButtonIconOnlyLink(t *testing.T) {
	...
	b := &bytes.Buffer{}
	Button().Kind("primary").Icon(Raw(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" preserveAspectRatio="xMidYMid meet" width="16" height="16" aria-hidden="true" role="img" class="bx--btn__icon" style="margin-left: 0" aria-label="Add"><path d="M16 16V8h-2v8H6v2h8v8h2v-8h8v-2z"></path></svg>`)).IconDescription("Add").Href("#").Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
...
func TestButtonIconOnlyGhostSelected(t *testing.T) {
	...
	b := &bytes.Buffer{}
	Button().Kind("ghost").Icon(Raw(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" preserveAspectRatio="xMidYMid meet" width="16" height="16" aria-hidden="true" role="img" class="bx--btn__icon" style="margin-left: 0" aria-label="Add"><path d="M16 16V8h-2v8H6v2h8v8h2v-8h8v-2z"></path></svg>`)).IconDescription("Add").Selected(true).Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
