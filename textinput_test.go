...
func TestTextInputDefault(t *testing.T) {
	...
	b := &bytes.Buffer{}
	TextInput("User name").Placeholder("Enter user name...").Render(b)
...
func TestTextInputWithHelperText(t *testing.T) {
	...
	b := &bytes.Buffer{}
	TextInput("User name").HelperText("Your user name is associated with your email").Placeholder("Enter user name...").Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
...
func TestTextInputHiddenLabel(t *testing.T) {
	...
	b := &bytes.Buffer{}
	TextInput("User name").HideLabel(true).Placeholder("Enter user name...").Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
...
func TestTextInputLightVariant(t *testing.T) {
	...
	b := &bytes.Buffer{}
	TextInput("User name").Light(true).Placeholder("Enter user name...").Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
...
func TestTextInputInlineVariant(t *testing.T) {
	...
	b := &bytes.Buffer{}
	TextInput("User name").Inline(true).Placeholder("Enter user name...").Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
...
func TestTextInputXLSize(t *testing.T) {
	...
	b := &bytes.Buffer{}
	TextInput("User name").Size("xl").Placeholder("Enter user name...").Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
...
func TestTextInputSmSize(t *testing.T) {
	...
	b := &bytes.Buffer{}
	TextInput("User name").Size("sm").Placeholder("Enter user name...").Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
...
func TestTextInputDisabled(t *testing.T) {
	...
	b := &bytes.Buffer{}
	TextInput("User name").Disabled(true).Placeholder("Enter user name...").Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
...
func TestTextInputAttr(t *testing.T) {
	...
	b := &bytes.Buffer{}
	TextInput("User name").Placeholder("Enter user name...").Attr("hx-swap", "outerHTML").Render(b)
	if b.String() != expected {
		t.Errorf("got %s, want %s", b.String(), expected)
	}
}
